...
export const getNounsMissingPrompt: GetNounsMissingPrompt = ({lesson, errors}: GetNounsMissingPromptProps) => {
  ...
  return (`
REQUEST: Identify and return the singular form, plural form, and grammatical gender for each of the ${lesson.language} nouns listed below:
...
[
  "noun(singular)|noun(plural)|gender",
  "noun(singular)|noun(plural)|gender",
  "noun(singular)|noun(plural)|gender"
]
