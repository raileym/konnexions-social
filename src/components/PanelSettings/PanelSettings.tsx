...
const PanelSettings: React.FC = () => {
  ...
  const { settingsPanelFirstFocusRef, settingsPanelRef, isSettingsOpen } = useSettingsPanel()
  ...
  const headline = (
    <div className="flex flex-column">
      ...
      <button ref={settingsPanelFirstFocusRef} tabIndex={screenState[SCREEN.SETTINGS] ? 0 : -1} aria-disabled={!screenState[SCREEN.SETTINGS]} className="mv3" onClick={() => {setTheme('Midnight Sand')}}>Select MIDNIGHT SAND</button>
