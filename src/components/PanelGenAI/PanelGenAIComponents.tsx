...
import { ACTIVE_PANEL, LANGUAGE, SCENARIO_LABELS } from '@cknTypes/constants'
...
const PanelGenAI = () => {
  ...
  return (
    <div className={`panel-gen-ai-components panel-right panel-gen-ai-components bw1 b--moon-gray bl z-1 absolute top-0 left-0 w-90 h-100 bg-light-gray transition-transform translate-x-0 ${isOpen ? 'panel-visible' : 'panel-hidden'} ${!isMounted ? 'dn' : ''}`}>
