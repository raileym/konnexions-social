          ...
          { !openAiKey && (
              <div className='mt5'>
                ...
                <div className='w-100 flex justify-center pa4'>
                  <div>
                    <Button tabIndex={screenState[SCREEN.GEN_AI] ? 0 : -1} aria-hidden={!screenState[SCREEN.GEN_AI]} switchFn={switchPanel} isActive={false} panel='keys' icon={faKey} title='API Keys' />
                  </div>
                </div>
              </div>
          )}
