  ...
  return (
    <div className="pa3 bg-background">
      ...
      <div className="mt3 flex gap2">
        <button
          className="w4 f6 mr2 br3 ba bw1 ph3 pv2 mb2 dib background b--green bg-green hover:b--green active:bg-oceanblue active:on-background"
        ...
        <button
          className="w4 f6 ml2 br3 ba bw1 ph3 pv2 mb2 dib background b--yellow bg-yellow hover:b--yellow active:bg-oceanblue active:on-background"
