  ...
  return (
    <div className="pa3 bg-black">
      ...
      <div className="mt3 flex gap2">
        <button
          className="w4 f6 mr2 br3 ba bw1 ph3 pv2 mb2 dib black b--green bg-green hover:b--green active:bg-oceanblue active:white"
        ...
        <button
          className="w4 f6 ml2 br3 ba bw1 ph3 pv2 mb2 dib black b--yellow bg-yellow hover:b--yellow active:bg-oceanblue active:white"
