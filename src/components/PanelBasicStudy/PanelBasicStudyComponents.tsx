...
// const { openPanel, closePanel, focusPanel } = usePanelManager()
  ...
  return (
    <div inert={!isOpen} className={`panel-basic-study-components panel-right z-1 absolute top-0 left-0 w-100 h-100 flex ${isOpen ? 'panel-visible' : 'panel-hiddenX'} ${!isMounted ? 'dnX' : ''}`}>
