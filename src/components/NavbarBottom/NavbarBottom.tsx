...
const NavbarBottom = () => {
  ...
  return (
    <nav
      className={`
        navbar-bottom fixed bottom-0 bt b--background-30 left-0 w-100 flexX flex-column items-center bg-secondary justify-aroundX ph3 pv2 transition-transform
        ${translateY} z-999 br0
