...
const PanelGenAIPro: React.FC = () => {
  ...
  return (
    ...
    <div className={`panel-right baX bw1 b--moon-gray bl gen-ai-pro-panel z-2 absolute top-0 left-10 w-90 h-100 bg-light-greenX flex flex-rowX transition-transform ${translateX}`}>
      <RightPanel />
