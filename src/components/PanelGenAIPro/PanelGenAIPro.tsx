...
const PanelGenAIPro: React.FC = () => {
  ...
  return (
    ...
    <div className={`panel-right panel-gen-ai-pro baX bw1 b--moon-gray bl panel-gen-ai-pro z-1 absolute top-0 left-10 w-90 h-100 bg-light-greenX flex flex-rowX transition-transform ${translateX}`}>
      <RightPanel />
