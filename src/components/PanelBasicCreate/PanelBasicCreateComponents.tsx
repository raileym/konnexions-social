...
const PanelBasicCreateComponents = () => {
  ...
  return (
    <div
      // inert={!isOpen}
      className={`
        panel-basic-create-components panel-right bw1 b--moon-gray bl panel-basic z-1 absolute top-0 left-0 w-100 h-100 bg-transparent flexX flex-rowX transition-transform translate-x-0
