...
<div className="pa4">
  ...
  <LegalBlock label='A'>
  Welcome to MyKonnections.com (**SAAS**), a Software-As-A-Service that engages our customers (**End User**) with tools and interactive experiences (**Engagement Features**) that spark conversation, encourage participation, and help our customers feel more connected to others.

  The SAAS demonstrates how the Site uses the MyKonnections Technical Platform (**Platform**) to partition, select, deliver, and arrange Content as a related set of citations.

  Welcome to MyKonnections.com (**SAAS**), a Software-As-A-Service that connects our customers (**End User**) to engaging tools and interactive experiences (**Engagement Features**) that spark conversation, encourage participation, and help people feel more connected to one another.
  
  <br/> for teaching math (**Topic**) through study guides that feature flashcards, dynamic questions, interactive graphics, and videos (collectively, the **Content**). The SAAS demonstrates how the Site uses the MyKonnections Technical Platform (**Platform**) to partition, select, deliver, and arrange Content as a related set of citations.
  </LegalBlock>
  ...
  <LegalBlock title='CONTENT' label='3'>
    <LegalBlock>
  ...
  <LegalBlock title='OUR TRADEMARKS' label='5'>
    <LegalBlock>
      CITEPREP and CITE are registered trademarks in the United State Other graphics, logos, designs, page headers, button icons, and toolbars appearing on the Site may be trademarks in the United States and other countries (collectively, with the registered trademarks, the **Marks**). All other logos and trademarks are trademarks of their respective owner You are not authorized to use any Marks without our prior written permission. Ownership of all Marks and the goodwill associated therewith remains with u
    </LegalBlock>
  </LegalBlock>
...
<LegalBlock title='DATA RIGHTS AND PUBLISHER PRIVACY POLICIES' label='8'>
    <LegalBlock>
      We do not charge End Users to access the Site or use the Product However, we may collect **Data** related to an End User&apos;s use of the Product. Our Data collection, use, and disclosure practices are described more fully in our <a href={'/privacy-policy/'}>Privacy Policy</a> and include the use of log information and cookies that record anonymous (i.e., non-personal) information about our End User
    </LegalBlock>
    ...
    <LegalBlock>
      If you are an End User and prefer that we do not collect, and do not assist others in the collection of, Data about your usage of our Site, you you may reach us using the <a href={'#contact'}>contact form</a> below and we will respond in a reasonable time in order to assist you in discontinuing our placement of cookies related to this Data collection. If you do not cause us to discontinue the placement of our cookies, you grant us a non-exclusive, perpetual, worldwide and irrevocable right and license to collect, use and disclose the Data as provided in our <a href={'/privacy-policy/'}>Privacy Policy</a> and to allow our third party data partners to do the same.
    </LegalBlock>
  ...
  <LegalBlock title='PRIVACY' label='9'>
    <LegalBlock>
  ...
  <LegalBlock title='GEOGRAPHICAL RESTRICTIONS' label='10'>
    <LegalBlock>
  ...
  <LegalBlock title='MODIFICATIONS TO TERMS' label='11'>
    <LegalBlock>
  ...
  <LegalBlock title='MODIFICATIONS TO THE SITE OR PRODUCT' label='12'>
    <LegalBlock>
  ...
  <LegalBlock title='TERMINATION' label='13'>
    <LegalBlock>
  ...
  <LegalBlock title='COPYRIGHT VIOLATIONS' label='14'>
    <LegalBlock>
  ...
  <LegalBlock title='DISCLAIMERS' label='15'>
    <LegalBlock>
  ...
  <LegalBlock title='LIMITATIONS OF LIABILITY AND CONTENT' label='16'>
    <LegalBlock>
  ...
  <LegalBlock title='INDEMNIFICATION' label='17'>
    <LegalBlock>
  ...
  <LegalBlock title='ELECTRONIC COMMUNICATIONS' label='18'>
    <LegalBlock>
  ...
  <LegalBlock title='HEADINGS' label='21'>
    <LegalBlock>
  ...
  <LegalBlock title='TRANSFERABILITY AND ASSIGNABILITY' label='22'>
    <LegalBlock>
  ...
  <LegalBlock title='GENERAL TERMS' label='23'>
    <LegalBlock>
  ...
  <LegalBlock title='COMPLETENESS' label='24'>
    <LegalBlock>
