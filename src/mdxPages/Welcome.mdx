...
<h1 className="tc brand-red f3 f5-vvs f4-vs f3-s f2-m f1-ns"><MyKonnexionsTitle slashColor='brand' fontSizeInRem={3} color='brand-red' nominal={'Social Platform'} /></h1>
