...
<h1 className="tc brand-red fz-5-1200 fz-4-800 fz-3-600 fz-5X"><MyKonnexionsTitle slashColor='brand' color='brand-red' /></h1>
...
<MyKonnexionsTitleSpan lineHeight={1.5}/> is a technology, education, and research company that promotes ways to strengthen the social ties that connect us — for everyone’s better health and well-being.

At <MyKonnexionsTitleSpan lineHeight={1.5} />, we focus on how people connect, why they connect, and why it matters.
