...
import { HeadingMdx } from '@components/HeadingMdx/HeadingMdx'

<div id="main-content" className="tc">
  <img
    src="/img/transistor-boy-and-girl-drawing-at-the-childrens-table.png"
    alt={ARIA_LABEL_STRINGS.IMAGE_MAIN}
  />
</div>

<HeadingMdx ariaLabel={'My connections social platform'} level={1} className="tc secondary f3 f5-vvs f4-vs f3-s f2-m f1-ns">
  <MyKonnexionsTitle
    slashColor="primary"
    fontSizeInRem={3}
    color="secondary"
    nominal="Social Platform"
  />
</HeadingMdx>

<HeadingMdx level={2} className="f3 f4-m f2-l">Welcome and Mission</HeadingMdx>
...
<HeadingMdx level={2} className="f3 f4-m f2-l">What We Focus On</HeadingMdx>
...
<HeadingMdx level={2} className="f3 f4-m f2-l">Our Approach to Connection</HeadingMdx>
...
<HeadingMdx level={2} className="f3 f4-m f2-l">Why Connection Matters</HeadingMdx>
...
<HeadingMdx level={2} className="f3 f4-m f2-l">Interactive Tools That Help</HeadingMdx>
...
<HeadingMdx level={2} className="f3 f4-m f2-l">At the Heart of It All</HeadingMdx>
...
<HeadingMdx level={2} className="f3 f4-m f2-l">Reference</HeadingMdx>
...
<HeadingMdx level={1}>Nearly final statements</HeadingMdx>
...
At <MyKonnexionsTitleSpan />, we know that simply connecting people through technology is not enough to strengthen the ties they share. Therefore, we promote fun technologies that motivate people to connect.
