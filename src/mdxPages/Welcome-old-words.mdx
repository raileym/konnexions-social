...
<h1 className="tc brand-red fz-5-1200 fz-4-800 fz-3-600 fz-5X"><MyKonnexionsTitle slashColor='brand' fontSizeInRem={3} color='brand-red' nominal={'Social Platform'} /></h1>

Welcome to the <MyKonnexionsTitleSpan lineHeight={1.5} nominal="Social Platform" />, a technology platform developed and operated by Professor Malcolm's LLC, doing business as <MyKonnexionsTitleSpan lineHeight={1.5} nominal="Social" />.

<MyKonnexionsTitleSpan lineHeight={1.5} nominal="Social" /> is more than a name — it’s a mission-driven technology, education, and research initiative committed to strengthening the social ties that connect us, for everyone’s better health and well-being.

At <MyKonnexionsTitleSpan lineHeight={1.5} nominal="Social" />, we focus on how people connect, why they connect, and why it matters.
...
Welcome to the <MyKonnexionsTitleSpan lineHeight={1.5} nominal={'Social Platform'} />, a technology platform owned and
operated by Professor Malcolm's LLC, doing business as <MyKonnexionsTitleSpan lineHeight={1.5} nominal={'Social'}/>.

<MyKonnexionsTitleSpan lineHeight={1.5} nominal={'Social'}/> is a technology, education, and research company that promotes ways to strengthen the social ties that connect us — for everyone’s better health and well-being.
...
<div className="flex flex-row f1 b" style={{lineHeight: '1em'}}>
  <div className="mh0 ph0 moon-gray f2X">My Konne</div>
  <MyKonnexionsSlash />
  <div className="ml3X pl2X mh0X ph0 o-20">ions</div>
</div>

<div className="ba konnexionsX flex flex-row f1 redX b" style={{lineHeight: '1em'}}>
  <div className="mh0 ph0 o-20 f2X">My Konne</div>
  <MyKonnexionsSlash />
  <div className="ml3 pl2X mh0X ph0 o-20">xxx ions</div>
</div>
...
<div className="konnexionsX flex flex-row f1 redX b">
  ...
  <div className="flex flex-row relative">
    ...
    <div className="konnexion-slash absolute">x</div>
  </div>
  <div className="ml3X pl2X mh0 ph0 o-20">ions</div>
</div>

<span className="konnexions">Konne<span className="konnex"><span className="slash-wrapper"><span className="slash-one">\\</span><span className="slash-two">\\</span></span></span>&nbsp;&nbsp;ions</span>

At <MyKonnexionsTitleSpan /> , we promote ways to enable people to connect, the motivation to connect, and the reasons why it's important.
